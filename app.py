...
def add_xp(amount):
    ...
    if new_level > st.session_state.level:
        ...
        st.success(f"🎉 Seviye atladınız! Yeni seviye: {new_level}")
...
# ============================================================
# TTS — WINDOWS + STREAMLIT CLOUD UYUMLU
# ============================================================

def _windows_speak(text):
    """Yerel Windows kullanımında pyttsx3 ile konuşur."""
    try:
        import pyttsx3
        def run_speech():
            try:
                ...
                selected_voice = None
                for voice in voices:
                    voice_text = (str(getattr(voice, "name", "")) + " " + str(getattr(voice, "id", ""))).lower()
...
def _cloud_tts_audio(text):
    """Bulut ortamında MP3 üretir; tarayıcıya st.audio ile gönderilir."""
    import edge_tts
    async def create_audio():
        communicate = edge_tts.Communicate(text, voice="en-US-AriaNeural", rate="-5%", volume="+0%")
        chunks = []
        async for chunk in communicate.stream():
            if chunk["type"] == "audio":
                chunks.append(chunk["data"])
        return b"".join(chunks)
    return asyncio.run(create_audio())

def speak_text(text):
    """Windows'ta pyttsx3; Linux/Streamlit Cloud'da edge-tts kullanır."""
    text = str(text or "").strip()
    if not text:
        return
    if platform.system().lower() == "windows" and _windows_speak(text):
        return
    try:
        st.session_state.tts_audio = _cloud_tts_audio(text)
        st.session_state.tts_audio_text = text
    except Exception as e:
        st.warning("🔊 Bulut ses sistemi şu anda kullanılamıyor. Ayrıntı: " + str(e))
...
def _conversation_question_bank():
    """Sabit ve doğru İngilizce/Türkçe konuşma soruları.
    Çeviri hatalarını önlemek için sorular Hermes tarafından çevrilmez.
    """
    return [
        {"english": "What is your name?", "turkish": "Adın ne?"},
        {"english": "Where are you from?", "turkish": "Nerelisin?"},
        ...
        {"english": "What is your favorite color?", "turkish": "En sevdiğin renk nedir?"},
        {"english": "What is your favorite food?", "turkish": "En sevdiğin yemek nedir?"},
        {"english": "What is your favorite drink?", "turkish": "En sevdiğin içecek nedir?"},
        {"english": "What is your favorite movie?", "turkish": "En sevdiğin film nedir?"},
        {"english": "What is your favorite song?", "turkish": "En sevdiğin şarkı nedir?"},
        {"english": "What is your favorite hobby?", "turkish": "En sevdiğin hobin nedir?"},
        {"english": "Do you like music?", "turkish": "Müzik sever misin?"},
        {"english": "Do you like watching movies?", "turkish": "Film izlemeyi sever misin?"},
        {"english": "Do you like reading books?", "turkish": "Kitap okumayı sever misin?"},
        {"english": "Do you have a pet?", "turkish": "Evcil hayvanın var mı?"},
        {"english": "Do you have any brothers or sisters?", "turkish": "Kız veya erkek kardeşin var mı?"},
        {"english": "What time do you wake up?", "turkish": "Saat kaçta uyanırsın?"},
        {"english": "What time do you go to bed?", "turkish": "Saat kaçta yatarsın?"},
        {"english": "What do you do in the morning?", "turkish": "Sabahları ne yaparsın?"},
        {"english": "What do you do in the evening?", "turkish": "Akşamları ne yaparsın?"},
        {"english": "What do you usually eat for breakfast?", "turkish": "Kahvaltıda genellikle ne yersin?"},
        {"english": "What do you usually do on weekends?", "turkish": "Hafta sonları genellikle ne yaparsın?"},
        {"english": "What is your favorite day of the week?", "turkish": "Haftanın en sevdiğin günü hangisi?"},
        {"english": "What is your favorite season?", "turkish": "En sevdiğin mevsim hangisi?"},
        {"english": "What is your favorite place?", "turkish": "En sevdiğin yer neresi?"},
        {"english": "What city would you like to visit?", "turkish": "Hangi şehri ziyaret etmek istersin?"},
        {"english": "Which country would you like to visit?", "turkish": "Hangi ülkeyi ziyaret etmek istersin?"},
        {"english": "Have you ever traveled abroad?", "turkish": "Hiç yurt dışına çıktın mı?"},
        {"english": "How do you usually travel?", "turkish": "Genellikle nasıl seyahat edersin?"},
        {"english": "What do you usually buy at the supermarket?", "turkish": "Süpermarketten genellikle ne alırsın?"},
        {"english": "What is your favorite restaurant?", "turkish": "En sevdiğin restoran hangisi?"},
        {"english": "What food can you cook?", "turkish": "Hangi yemekleri yapabilirsin?"},
        {"english": "Can you make coffee?", "turkish": "Kahve yapabilir misin?"},
        {"english": "What kind of music do you like?", "turkish": "Ne tür müzik seversin?"},
        {"english": "Who is your favorite singer?", "turkish": "En sevdiğin şarkıcı kim?"},
        {"english": "What sport do you like?", "turkish": "Hangi sporu seversin?"},
        {"english": "Do you play any sports?", "turkish": "Herhangi bir spor yapıyor musun?"},
        {"english": "What do you do for fun?", "turkish": "Eğlenmek için ne yaparsın?"},
        {"english": "What do you usually do after work?", "turkish": "İşten sonra genellikle ne yaparsın?"},
        {"english": "What do you like about your city?", "turkish": "Şehrinde neyi seviyorsun?"},
        {"english": "What is the weather like today?", "turkish": "Bugün hava nasıl?"},
        {"english": "What is your favorite month?", "turkish": "En sevdiğin ay hangisi?"},
        {"english": "What do you usually do when you are tired?", "turkish": "Yorgun olduğunda genellikle ne yaparsın?"},
        {"english": "What makes you happy?", "turkish": "Seni ne mutlu eder?"},
        {"english": "What makes you laugh?", "turkish": "Seni ne güldürür?"},
        {"english": "What are you good at?", "turkish": "Neyi iyi yaparsın?"},
        {"english": "What would you like to learn?", "turkish": "Ne öğrenmek istersin?"},
        {"english": "Why are you learning English?", "turkish": "Neden İngilizce öğreniyorsun?"},
        {"english": "How often do you practice English?", "turkish": "Ne sıklıkla İngilizce pratik yaparsın?"},
        {"english": "What is difficult about English?", "turkish": "İngilizcede zor olan şey nedir?"},
        {"english": "What English word do you like?", "turkish": "Hangi İngilizce kelimeyi seviyorsun?"},
        {"english": "What are you doing today?", "turkish": "Bugün ne yapıyorsun?"},
        {"english": "What did you do yesterday?", "turkish": "Dün ne yaptın?"},
        {"english": "What did you eat today?", "turkish": "Bugün ne yedin?"},
        {"english": "What are you going to do tomorrow?", "turkish": "Yarın ne yapacaksın?"},
        {"english": "What are your plans for the weekend?", "turkish": "Hafta sonu planların neler?"},
        {"english": "What is your dream job?", "turkish": "Hayalindeki iş nedir?"},
        {"english": "Where would you like to live?", "turkish": "Nerede yaşamak istersin?"},
        {"english": "What is important to you?", "turkish": "Senin için önemli olan nedir?"},
    ]


def normalize_conversation_question(question):
    """Konuşma sorusunu her durumda doğru İngilizce/Türkçe çifti olarak normalize eder."""
    bank = _conversation_question_bank()

    if isinstance(question, dict):
        english = str(question.get("english", "")).strip()
        turkish = str(question.get("turkish", "")).strip()

        # Eski Hermes çıktısı yanlış/JSON biçimindeyse sabit bankadan düzelt.
...
def generate_conversation_question():
    """Doğru İngilizce + doğru Türkçe karşılığı olan yeni soru seç."""
    bank = _conversation_question_bank()
    used = st.session_state.conversation_used_questions

    available = [q for q in bank if q["english"] not in used]
    if not available:
        used.clear()
        available = bank[:]
...
def evaluate_conversation_answer(question, answer):
    ...
    # --------------------------------------------------------
    # 27) HERMES SECOND-LEVEL JUDGE / CLOUD FALLBACK
    # --------------------------------------------------------
    # Streamlit Cloud'da 127.0.0.1 üzerindeki yerel Ollama bulunmaz.
    # Bu nedenle bulut ortamında K.A.R.T.A.L. kural tabanlı motoru kullanılır.
    if platform.system().lower() != "windows":
        if len(a_words) >= 2:
            return result(
                True,
                "Cevabın anlaşılır görünüyor.",
                "Bulut modunda temel anlam kontrolü yapıldı; küçük grammar hataları tolere edilir.",
                confidence="medium",
                score=85,
            )
        return result(
            ...
            "Soruyu karşılayan kısa ama anlamlı bir İngilizce cevap ver.",
            confidence="medium",
            score=20,
        )
...
st.sidebar.write(
    f"🏆 Seviye: **{st.session_state.level}**"
)
...
if menu == "🏠 Ana Sayfa":
    ...
    st.write(
        "1. 10 yeni kelime öğrenin."
    )

    st.write(
        "2. 5 cümleyi sesli söyleyin."
    )

    st.write(
        "3. Mini quiz'i tamamlayın."
    )
...
# ============================================================
    ...
    st.write(
        ...
        "Hermes 3B ile cevabınızı değerlendirip konuşmayı sürdürüyor."
    )

    learner_level = "A1" if st.session_state.level <= 3 else "A2"
    st.info(f"🎯 Mevcut İngilizce seviyesi: **{learner_level}**")
    ...
    with col1:
        if st.button(
            ...
            try:
                ...
                st.error(str(e))
                st.info("Bulut sürümünde yerel Ollama kullanılmaz. K.A.R.T.A.L. temel değerlendirme motoruyla çalışmaya devam eder.")
    ...
    if not st.session_state.conversation_started:
        ...
        st.markdown(
            ...
            5. Hermes 3B cevabınızı değerlendirir.
            ...
            if spoken:
                ...
                if spoken.strip() == st.session_state.conversation_last_answer.strip():
                    ...
                    try:
                        ...
                        # Doğru cevapta XP ver ve otomatik olarak yeni soruya geç.
        ...
        st.caption(
            "🧠 Değerlendirme: K.A.R.T.A.L. motoru  •  "
...
if st.session_state.get("tts_audio"):
    ...
    st.caption(f"🔊 K.A.R.T.A.L. seslendiriyor: {st.session_state.get('tts_audio_text', '')}")
...
st.sidebar.caption(
    "K.A.R.T.A.L. Engine • Whisper • Windows/Cloud TTS"
)